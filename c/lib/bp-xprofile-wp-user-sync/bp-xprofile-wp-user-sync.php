...
class BpXProfileWordPressUserSync {
	...
	public function intercept_wp_user_update( $user_id ) {
		...
		if ( bp_is_active( 'xprofile' ) ) {
			...
			$testing1 = update_user_meta( $user_id, 'first_name', $first_name );
			$testing2 = update_user_meta( $user_id, 'last_name', $last_name );
	...
	public function intercept_wp_fb_profile_sync( $facebook_user, $wp_user_id ) {
		...
		*/
		...
		$testing1 = update_user_meta($wp_user_id, 'first_name', $first_name);
		$testing2 = update_user_meta($wp_user_id, 'last_name', $last_name);
